 ...
 <div className="container" data-aos="fade-up">
   <div className="row about-container">
     ...
     <img className={classes.slika}  style={{height: '400px',
                width: null,
                flex: 1 }}src="https://media.istockphoto.com/photos/dog-walker-picture-id1126947324?k=20&m=1126947324&s=612x612&w=0&h=-ezh7aau25V9ELwyUvRe6PXMr5vDBFruz9JAZavBgsk=" class="glightbox play-btn mb-4"/>
     </div>
     </CardContent>
 </div>
</div>
